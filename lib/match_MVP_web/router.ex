defmodule Match_MVPWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {Match_MVPWeb.Layouts, :root}
  ...
  # scope "/api", Match_MVPWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:match_MVP, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: Match_MVPWeb.Telemetry
