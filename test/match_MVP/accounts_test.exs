# defmodule Match_MVP.AccountsTest do
#   use Match_MVP.DataCase

#   alias Match_MVP.Accounts

#   import Match_MVP.AccountsFixtures
#   alias Match_MVP.Accounts.{User, UserToken}

#   describe "get_user_by_username/1" do
#     test "does not return the user if the username does not exist" do
#       refute Accounts.get_user_by_username("example")
#     end
...
#     test "does not return the user if the username does not exist" do
#       refute Accounts.get_user_by_username_and_password("example", "hello world!")
#     end
...
#     test "requires username, password and role to be set" do
